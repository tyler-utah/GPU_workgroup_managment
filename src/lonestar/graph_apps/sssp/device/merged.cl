...
uint processnode2(__global IW_barrier *__bar, __global Kernel_ctx *__k_ctx,
                  ...
                  __local int *queue_index, __local int *scan_arr,
                  __local int *loc_tmp, __local int *src, unsigned iteration,
                  // Graph
                  uint g_nnodes,
...
void drelax2(__global uint *dist,
             ...
             Restoration_ctx *__restoration_ctx, __local int * __sense) {
...
#define PERSISTENT_KERNEL                                                      \
  drelax2(dist, a_inwl_index, a_outwl_index, a_inwl_wl, a_outwl_wl, g_nnodes,  \
          g_edgessrcdst, g_psrc, g_edgessrcwt, gather_offsets, queue_index,    \
          scan_arr, loc_tmp, src, bar, persistent_kernel_ctx, s_ctx,           \
          scratchpad, &r_ctx_local, &__sense)
