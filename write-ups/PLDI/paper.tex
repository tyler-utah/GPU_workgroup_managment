...
In Section~\ref{sec:cooperativeexamples} we show how the work stealing
...
\ADComment{Revise: we're folding this into the overview of the examples.}
...
\ADComment{Fold this in:}

Using coopeative kernels requires some programmer effort 

\ADComment{Lifted:} , after which
we explain how the work stealing and graph traveral algorithms of
Section~\ref{sec:openclexamples} can be turned into cooperative kernels
that use the extensions.
...
\ADComment{TODO.  We want to show the examples from Section~\ref{sec:openclexamples} ported to use cooperative kernels.  We want to make it clear that it is easy to place the primitives.}
