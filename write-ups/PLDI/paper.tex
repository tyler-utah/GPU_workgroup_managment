...
signalling a cooperative kernel to enable $\offerkill$). The scheduler
...
system issues like GPU deadlock or blue screens---which we tend to think
are manifestations of driver bugs.
...
\myfig~\ref{fig:fine-grained-timing} reports the measure for three
