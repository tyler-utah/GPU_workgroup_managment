...
Using work stealing as an example: in the kernel of \myfig\ref{...}, a
...
of the GPU that is used for execution.  In \mysec\ref{...} we conduct
...
implementation of cooperative scheduling (\mysec\ref{ }) is as
...
algorithm of \myfig\ref{ } illustrates this: the algorithm is prepared
