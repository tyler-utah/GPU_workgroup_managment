...
The introduction of cooperative scheduling primitives introduces an
overhead even if no killing, forking or resizing ever happen. We
measure this overhead by comparing execution times of the original
kernel and the cooperative one, forcing the scheduler to never modify
the number of active workgroups. Since the cooperative kernel contains
the non-persistent task code anyway, its occupancy bound may be less
