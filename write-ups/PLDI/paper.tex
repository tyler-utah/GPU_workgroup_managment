...
version of the work stealing example of \myfig\ref{...} that we
...
\caption{Cooperative version of the work stealing example from \myfig\ref{fig:XXX}; the number of workpools
...
In \mysec\ref{ } we describe the set of irregular GPU algorithms used
...
Like the simplified example of \myfig\ref{ }, the work stealing algorithms have a transactional flavour
