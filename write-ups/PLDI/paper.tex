...
not require reshaping of the original algorithm. Most graph applications
are executed on 2 different data sets, such that in total we have 13
application/data set pairs.
...
\hline
\# comp. units  & 24 & \ADComment{...} & \ADComment{...} \\
Driver   & 20.19.15.4501 & \ADComment{...} & \ADComment{...} \\
Host CPU & i3-6100U & \ADComment{...} & \ADComment{...} \\
\end{tabular}
