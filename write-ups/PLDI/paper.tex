...
algorithms using GPUs~\cite{...,TPO10}, and on the \emph{persistent threads}
...
\paragraph{Dynamic parallelism} Recent version of CUDA and OpenCL allow a kernel to spawn further kernels~\cite{CUDASpec,opencl2Spec}.
