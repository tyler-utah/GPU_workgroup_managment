...
issue $\offerkill$ and $\offerfork$ calls directly.


 then the only possibility for the number of
...
\\
\forall j\;.\;w_0'(j) = (l_{0,j}, \globalbarrier(); \offerfork(); \globalbarrier(); \offerkill(); \globalbarrier();\mathit{ss})
\\
