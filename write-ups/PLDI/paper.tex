...
workgroup should transmit the current value of this variable to serve
as an initial value for the new workgroups.  We detail the semantics
for this when we describe $\offerfork$ below.

\ADComment{Remove?}
Only private memory variables can be annotated with $\transmit$,
...
with $\transmit$.  \ADComment{The preceding is what we have
