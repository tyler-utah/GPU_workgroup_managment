...
\paragraph{Work stealing example}  \ADComment{Tyler/Hugues: can you please say in the first paragraph that this has been implemented on GPUs and cite the right papers?}
%
...
design, e.g.~\cite{XF}, to take account of a growing and shrinking number of workgroups, and the atomic operations provided by
