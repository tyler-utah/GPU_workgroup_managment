...
\caption{Execution time slowdown associated with cooperative scheduling mode without multi-tasking}
\label{tab:overhead}
\end{table}
...
appropriate care, facilitates responsive multi-tasking.
...
cooperative kernel may enable more efficient multi-tasking than
