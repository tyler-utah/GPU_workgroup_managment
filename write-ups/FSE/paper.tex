...
%%% and then visit the instructions page again (follow link in author-kit message)
...
by language standards or vendor implementations, and is unlikely to be respected in the future.
%
...
Experimental results using our megakernel-based prototype shows that
