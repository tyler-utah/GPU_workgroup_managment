...
graphics task asks for half or more of the resources. For example, a
medium graphics workload for bfs on the rmat input has over an
8$\times$ overhead when asking for all but one of the workgroups for
graphics. As \myfiglong\ref{fig:performance} shows, most of our
...
Given a graphics workload that is required to be scheduled with period
...
preemption, though, as discussted in \mysec{\ref{sec:intro}} and
