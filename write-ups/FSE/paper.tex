...
and online material~\cite{ }, and running litmus tests on a Pascal
platform, our understanding is that preemption of entire kernels, but
not of individual workgroups running a kenrel is supported.
Intel---the only vendor whose OpenCL implemenation is capable enough
to implement cooperative kernels---do not provide this feature, thus
we cannot make a direct comparison.  We present here a theoretical
