...
RelWithDebInfo\kernel_merge.exe %1 %2 -- -I C:\Users\afd\llvm39-build\Release\lib\clang\3.9.1\include -I ..\kernel_merge\stubs -include opencl-c.h -include stubs.h -cl-std=CL2.0
